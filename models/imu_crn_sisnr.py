...
from models.networks.crn import CRNN
from models.loss.sisnr_loss import calc_sdr_torch



# conditional_tasnet with sisnr loss
class IMUV_CRN_SISNR(nn.Module):
    def __init__(self):
        super(IMUV_CRN_SISNR, self).__init__()
...
#     # checkpoint dir
#     ckpt_dir = os.path.join(work_dir, 'alan_imuv/models/ckpt_imu_crn')
